...
TEST(array_constructor, case2) {
  ...
  s21::array<double, 5> s21_arr_double;
  s21::array<std::string, 5> s21_arr_string;

  EXPECT_EQ(s21_arr_int.size(), 5U);
  EXPECT_NE(&s21_arr_int[0], nullptr);

  EXPECT_EQ(s21_arr_double.size(), 5U);
  EXPECT_NE(&s21_arr_double[0], nullptr);

  EXPECT_EQ(s21_arr_string.size(), 5U);
  EXPECT_NE(&s21_arr_string[0], nullptr);
}
...
TEST(array_constructor, case3) {
  ...
  EXPECT_EQ(s21_arr_int[2], 8);
  EXPECT_EQ(s21_arr_int[3], 9);

  EXPECT_EQ(s21_arr_double.size(), 4U);
  EXPECT_EQ(s21_arr_double[0], 1.4);
  EXPECT_EQ(s21_arr_double[1], 4.8);
  EXPECT_EQ(s21_arr_double[2], 8.9);
  EXPECT_EQ(s21_arr_double[3], 9.1);

  EXPECT_EQ(s21_arr_string.size(), 4U);
  EXPECT_EQ(s21_arr_string[0], "Hello");
  EXPECT_EQ(s21_arr_string[1], ",");
  EXPECT_EQ(s21_arr_string[2], "world");
  EXPECT_EQ(s21_arr_string[3], "!");
}

TEST(array_constructor, case4) {
  s21::array<int, 3> s21_arr_int{1, 4, 8, 9};
  s21::array<double, 3> s21_arr_double{1.4, 4.8, 8.9, 9.1};
  s21::array<std::string, 3> s21_arr_string{"Hello", ",", "world", "!"};

  EXPECT_EQ(s21_arr_int.size(), 3U);
  EXPECT_EQ(s21_arr_int[0], 1);
  EXPECT_EQ(s21_arr_int[1], 4);
  EXPECT_EQ(s21_arr_int[2], 8);

  EXPECT_EQ(s21_arr_double.size(), 3U);
  EXPECT_EQ(s21_arr_double[0], 1.4);
  EXPECT_EQ(s21_arr_double[1], 4.8);
  EXPECT_EQ(s21_arr_double[2], 8.9);

  EXPECT_EQ(s21_arr_string.size(), 3U);
  EXPECT_EQ(s21_arr_string[0], "Hello");
  EXPECT_EQ(s21_arr_string[1], ",");
  EXPECT_EQ(s21_arr_string[2], "world");
}

TEST(array_constructor, case5) {
  s21::array<int, 4> s21_vec_ref_int{1, 4, 8, 9};
  s21::array<int, 4> s21_vec_res_int(s21_vec_ref_int);

  s21::array<double, 4> s21_vec_ref_double{1.4, 4.8, 8.9, 9.1};
  s21::array<double, 4> s21_vec_res_double(s21_vec_ref_double);

  s21::array<std::string, 4> s21_vec_ref_string{"Hello", ",", "world", "!"};
  s21::array<std::string, 4> s21_vec_res_string(s21_vec_ref_string);
...
TEST(array_constructor, case6) {
  s21::array<int, 4> s21_vec_ref_int{1, 4, 8, 9};
  s21::array<int, 4> s21_vec_res_int = std::move(s21_vec_ref_int);
  s21::array<double, 4> s21_vec_ref_double{1.4, 4.8, 8.9, 9.1};
  s21::array<double, 4> s21_vec_res_double = std::move(s21_vec_ref_double);
  s21::array<std::string, 4> s21_vec_ref_string{"Hello", ",", "world", "!"};
  s21::array<std::string, 4> s21_vec_res_string = std::move(s21_vec_ref_string);
...
TEST(array_constructor, case7) {
  s21::array<int, 4> s21_vec_ref_int{1, 4, 8, 9};
  s21::array<int, 4> s21_vec_res_int;
  s21_vec_res_int = s21_vec_ref_int;

  s21::array<double, 4> s21_vec_ref_double{1.4, 4.8, 8.9, 9.1};
  s21::array<double, 4> s21_vec_res_double;
  s21_vec_res_double = s21_vec_ref_double;

  s21::array<std::string, 4> s21_vec_ref_string{"Hello", ",", "world", "!"};
  s21::array<std::string, 4> s21_vec_res_string;
  s21_vec_res_string = s21_vec_ref_string;
...
TEST(array_swap, case1) {
  s21::array<int, 4> s21_vec_ref_int{1, 4, 8, 9};
  s21::array<int, 4> s21_vec_res_int{0, 0, 0, 0};

  s21::array<double, 4> s21_vec_ref_double{1.4, 4.8, 8.9, 9.1};
  s21::array<double, 4> s21_vec_res_double{0.0, 0.0, 0.0, 0.0};
  ...
  EXPECT_EQ(s21_vec_res_int.size(), 4U);
  EXPECT_EQ(s21_vec_res_int[2], 8);
  EXPECT_EQ(s21_vec_ref_int[2], 0);

  EXPECT_EQ(s21_vec_res_double.size(), 4U);
  EXPECT_EQ(s21_vec_res_double[2], 8.9);
  EXPECT_EQ(s21_vec_ref_double[2], 0);

  EXPECT_EQ(s21_vec_res_string.size(), 4U);
  EXPECT_EQ(s21_vec_res_string[2], "world");
  EXPECT_EQ(s21_vec_ref_string[2], "");
}
...
TEST(array_fill, case1) {
  ...
  s21_vec_ref_int.fill(666);
  s21_vec_ref_double.fill(7.27);
  s21_vec_ref_string.fill("asdf");

  for (auto it : s21_vec_ref_int) {
    EXPECT_EQ(it, 666);
  }
  for (auto it : s21_vec_ref_double) {
    EXPECT_EQ(it, 7.27);
  }
  for (auto it : s21_vec_ref_string) {
    EXPECT_EQ(it, "asdf");
  }
}
